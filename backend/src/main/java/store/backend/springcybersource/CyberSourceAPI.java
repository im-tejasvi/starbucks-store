...
public class CyberSourceAPI {
  ...
  private PostResponse sendPost(String url) {
    ...
    try {
      ...
      con.setRequestProperty(
        "profile-id",
        "93B32398-AD51-4CC2-A682-EA3E93614EB1"
      );
  ...
  private StringBuilder getSignatureHeader(String httpMethod) throws Exception {
    ...
    if (httpMethod.equalsIgnoreCase("GET")) signatureHeaderValue.append(
      ", headers=\"" + getHeaders + "\""
    ); else if (
  ...
  private String getSignatureParam(String httpMethod) throws Exception {
    ...
    if (httpMethod.equalsIgnoreCase("GET")) signatureString.append(
      getRequestTarget
    ); else if (httpMethod.equalsIgnoreCase("POST")) signatureString.append(
      postRequestTarget
    );
    ...
    String base64EncodedSignature = Base64
      .getEncoder()
